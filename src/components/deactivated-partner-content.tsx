...
import { UserCheck, ArrowUpDown, ArrowLeft } from 'lucide-react';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
       ...
       <Card>
            <CardHeader>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <CardTitle>Deactivated Partners</CardTitle>
                        <CardDescription>View and reactivate partners.</CardDescription>
                    </div>
                </div>
            </CardHeader>
            <CardContent className='p-0'>
