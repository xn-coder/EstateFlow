          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField control={form.control} name="dob" render={({ field }) => (
                ...
                <PopoverContent className="w-auto p-0" align="start">
                    <Calendar mode="single" selected={field.value} onSelect={field.onChange} captionLayout="dropdown-buttons" fromYear={oneHundredYearsAgo.getFullYear()} toYear={eighteenYearsAgo.getFullYear()} disabled={(date) => date > eighteenYearsAgo} initialFocus />
                </PopoverContent>
