...
const managementItems = [
  ...
  { label: 'Send Reward Points', dialogType: 'sendPoints', roles: [...ADMIN_ROLES, 'Seller'] },
  { label: 'Reward Points History', href: '/seller-reward-history', roles: [...ADMIN_ROLES, 'Seller'] },
