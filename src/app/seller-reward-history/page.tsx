...
import SellerRewardHistoryContent from '@/components/seller-reward-history-content';
import { ADMIN_ROLES } from '@/lib/roles';

function RewardHistorySkeleton() {
  return (
...
export default function SellerRewardHistoryPage() {
    ...
    <SidebarProvider>
      ...
      <SidebarInset className="flex flex-col">
        ...
        <main className="flex-1 bg-slate-50 dark:bg-slate-900 p-4 sm:p-6 lg:p-8">
          <SellerRewardHistoryContent currentUser={user} />
        </main>
        <DashboardFooter />
      </SidebarInset>
    </SidebarProvider>
