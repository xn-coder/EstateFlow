...
import DeactivatedPartnerContent from '@/components/deactivated-partner-content';
import DashboardFooter from '@/components/dashboard-footer';
import { ADMIN_ROLES } from '@/lib/roles';

function DeactivatedPartnerSkeleton() {
  return (
...
export default function DeactivatedPartnerPage() {
  ...
  if (loading || !user || !authorizedRoles.includes(user.role)) {
    return <DeactivatedPartnerSkeleton />;
  }
