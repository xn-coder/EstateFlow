...
import ReceivableCashListContent from '@/components/receivable-cash-list-content';
import DashboardFooter from '@/components/dashboard-footer';
import { ADMIN_ROLES } from '@/lib/roles';

function ReceivableCashListSkeleton() {
  return (
...
export default function ReceivableCashListPage() {
